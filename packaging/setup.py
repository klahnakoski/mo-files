...
setup(
    ...
    extras_require={"tests":["mo-testing>=7.559.24071"]},
    include_package_data=True,
    install_requires=["mo-dots==9.565.24076","mo-future==7.546.24057","mo-json==6.566.24076","mo-logs==8.566.24076","mo-math==7.565.24076"],
    license='MPL 2.0',
