...
setup(
    ...
    extras_require={"tests":["mo-testing>=8.685.25166"]},
    include_package_data=True,
    install_requires=["mo-dots==10.685.25166","mo-future==7.685.25166","mo-json==6.686.25166","mo-logs==8.685.25166","mo-math==7.685.25166"],
    license='MPL 2.0',
