...
setup(
    ...
    extras_require={"tests":["mo-testing>=8.644.24152"]},
    include_package_data=True,
    install_requires=["mo-dots==10.659.25005","mo-future==7.584.24095","mo-json==6.667.25032","mo-logs==8.667.25032","mo-math==7.659.25005"],
    license='MPL 2.0',
